...
**3. การเลือก (Selecting Elements)** jQuery ใช้ **CSS Selector**  | ในการเลือก element เช่นเดียวกับ CSS | Selector | ตัวอย่าง | ความหมาย |
| --- | --- | --- | --- |
| `$("#id")` | `$("#myDiv")` | เลือก element ที่มี `id="myDiv"` |
| `$(".class")` | `$(".box")` | เลือกทุก element ที่มี class `box` |
| `$("tag")` | `$("p")` | เลือก `<p>` ทุกตัวในหน้าเว็บ |
| `$("parent child")` | `$("div p")` | เลือก `<p>` ที่อยู่ใน `<div>` เท่านั้น |
| `$("element:first")` | `$("p:first")` | เลือก `<p>` ตัวแรก |
| `$("element:last")` | `$("p:last")` | เลือก `<p>` ตัวสุดท้าย |
| `$("element:eq(n)")` | `$("p:eq(2)")` | เลือก `<p>` ตัวที่ 3 (เริ่มนับจาก 0) |
...
**4. การจัดการ Event** **4.1 Event ที่ใช้บ่อย** | Event | คำอธิบาย | 
| --- | --- | 
...
**5. การเปลี่ยนแปลงเนื้อหาและ Attribute** **โอเค! เดี๋ยวผมจะอธิบาย **jQuery เบื้องต้นแบบละเอียด**  พร้อมตัวอย่างที่ชัดเจนมากขึ้น**jQuery คืออะไร?** **jQuery**  เป็นไลบรารี JavaScript ที่ช่วยให้เราทำงานกับ DOM ได้ง่ายขึ้น โดยเน้นไปที่ 
- **การเลือก element**  (เหมือน CSS Selector)
...
**5. การเปลี่ยนแปลงเนื้อหาและ Attribute** 5.1 เปลี่ยนข้อความ (`text()` และ `html()`)** 

```javascript
$("#title").text("ข้อความใหม่");  // เปลี่ยนข้อความเป็น "ข้อความใหม่"
$("#content").html("<b>เนื้อหาแบบ HTML</b>");  // ใส่ HTML ลงไป
```
**โอเค! เดี๋ยวผมจะอธิบาย **jQuery เบื้องต้นแบบละเอียด**  พร้อมตัวอย่างที่ชัดเจนมากขึ้น**jQuery คืออะไร?** **jQuery**  เป็นไลบรารี JavaScript ที่ช่วยให้เราทำงานกับ DOM ได้ง่ายขึ้น โดยเน้นไปที่ 
- **การเลือก element**  (เหมือน CSS Selector)
...
$("#myInput").val("ค่าใหม่");
```
5.3 เปลี่ยน Attribute (`attr()`)** 

```javascript
$("#myImage").attr("src", "new-image.jpg");  // เปลี่ยนรูปภาพ
```
